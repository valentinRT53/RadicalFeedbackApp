...
namespace RadicalFeedbackApp.Data
{
    public class SignalementService
    {
        ...
        public List<Signalement> GetAllSignalements()
        {
            ...
            while (reader.Read())
            {
                liste.Add(new Signalement
                {
                    ...
                    IdConversation = reader.IsDBNull(reader.GetOrdinal("ID_CONV"))
                        ? null : reader.GetInt32(reader.GetOrdinal("ID_CONV")),
                    ...
                    PrenomUtilisateur = reader.GetString(reader.GetOrdinal("PRENOM_UTILISATEUR")),
        ...
        public List<string> GetMessagesConversation(int idConv)
        {
            ...
            string query = "SELECT TEXT_MESSAGE FROM MESSAGE WHERE ID_CONV = @id ORDER BY ID_MESSAGE";
            using var cmd = new SqlCommand(query, conn);
